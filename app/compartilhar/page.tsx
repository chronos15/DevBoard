...
export default function ShareToDevboardPage() {
  ...
  React.useEffect(() => {
    if ("serviceWorker" in navigator) {
      void navigator.serviceWorker.register("/devboard-sw.js?v=223", { updateViaCache: "none" })
    ...
    // Na V223 o caminho principal é serverShare, usando request.formData() nativo no Route Handler.
    ...
    if (fallback) {
      ...
      setError(`${reasonText} Diagnóstico V223: ${type} · ${sizeLabel}.`)
