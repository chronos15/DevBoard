...
const SW_PATH = "/devboard-sw.js?v=227"
  ...
  React.useEffect(() => {
    ...
    const pending = notifications
      .filter((notification) => {
        ...
        if (notification.type === "followup-mention" || notification.type === "followup-update" || notification.type === "subactivity-comment" || notification.type === "subactivity-approval-approved" || notification.type === "subactivity-approval-rejected") return true
